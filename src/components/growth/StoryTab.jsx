    ...
    <div className="space-y-6">
      <Card className="p-5">
        <CardHeader
          ...
          subtitle={data.northStar.identity || 'Set a Future Identity in the Identity & Map tab to anchor this.'}
          action={
            chapters.length > 0 && (
      ...
      {chapters.length === 0 ? (
        <Card className="p-5">
          <EmptyState
            ...
            description="Add Problem / Action / Impact / Growth to a project or activity in Portfolio and it shows up here as a chapter of your story."
          />
        </Card>
      ) : (
      ...
      {unframedCount > 0 && (
        <Card className="p-5 flex items-center justify-between gap-3 flex-wrap">
          ...
          <div className="flex gap-2">
            <Button as={Link} to="/portfolio?tab=projects" size="sm" variant="secondary">Projects</Button>
            <Button as={Link} to="/portfolio?tab=activities" size="sm" variant="secondary">Activities</Button>
          </div>
        </Card>
      )}
    </div>
      ...
      <div className="flex items-start justify-between gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          {chapter.evidenceCount > 0 && (
            <Link
              to="/portfolio?tab=evidence"
              className="inline-flex items-center gap-1 text-[12px] text-neutral-400 hover:text-accent-600 dark:hover:text-accent-400"
            >
