...
const FIELD_MAP = {
  ...
  plannerBlocks: { startTime: 'start_time', endTime: 'end_time', linkedCommitmentId: 'linked_commitment_id', autoGenerated: 'auto_generated' },
}
...
const NULLABLE_FIELDS = {
  ...
  awards: ['date'],
  plannerBlocks: ['date', 'linkedCommitmentId'],
}
